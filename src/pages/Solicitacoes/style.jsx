...
import { getBackgroudStatus, getWidthStatus, getColorStatus, getMarginStatus, getPaddingStatus, getRadiusStatus, getBackgroudSelect } from './utils'
...
export const Op = styled.button`
  ...
  cursor: pointer;
  background-color: ${(props) => (props.select === 'true' || props.select === 'false') ? '#277DFF' : '#d9d9d9'};
  color: ${(props) => (props.select === 'true' || props.select === 'false') ? '#ffffff' : '#000000'};
